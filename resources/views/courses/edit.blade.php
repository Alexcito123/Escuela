            ...
            <form method="POST" action="{{ route('courses.update', $course) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="descripcion" rows="3"
                              class="w-full rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('descripcion', $course->descripcion) }}</textarea>
                </div>
                ...
                <div class="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <button type="submit" class="bg-amber-600 hover:bg-amber-700 text-white px-6 py-2 rounded-lg font-medium transition">Actualizar Curso</button>
                </div>
            </form>
        </div>
    </div>
