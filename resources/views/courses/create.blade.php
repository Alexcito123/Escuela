            ...
            <form method="POST" action="{{ route('courses.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="descripcion" rows="3"
                              class="w-full rounded-xl border border-gray-200 px-4 py-2 text-sm focus:ring-2 focus:ring-educlub/30 focus:border-educlub">{{ old('descripcion') }}</textarea>
                </div>
                ...
                <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                    ...
                    <button type="submit" class="bg-educlub hover:bg-educlub text-white px-6 py-2 rounded-xl font-medium transition">Guardar Curso</button>
                </div>
            </form>
        </div>
    </div>
