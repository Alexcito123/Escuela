...
<body class="font-sans antialiased min-h-screen flex items-center justify-center p-4" style="background-image: radial-gradient(circle at 10% 20%, rgba(74, 154, 147, 0.07) 0%, transparent 50%), radial-gradient(circle at 90% 80%, rgba(134, 185, 142, 0.07) 0%, transparent 50%), radial-gradient(circle at 85% 15%, rgba(222, 161, 162, 0.05) 0%, transparent 40%);">
