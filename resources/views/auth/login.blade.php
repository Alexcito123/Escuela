...
<body class="bg-slate-50 font-sans antialiased min-h-screen flex items-center justify-center p-4" style="background-image: radial-gradient(circle at 15% 20%, rgba(79, 195, 232, 0.18) 0%, transparent 45%), radial-gradient(circle at 85% 80%, rgba(126, 211, 160, 0.18) 0%, transparent 45%), radial-gradient(circle at 50% 50%, rgba(255, 200, 117, 0.12) 0%, transparent 45%);">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-educlub to-green-pastel rounded-3xl shadow-lg mb-5">
