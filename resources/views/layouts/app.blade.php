    ...
    <div class="min-h-screen flex">
        ...
        >
            ...
            <nav class="px-3 py-4 space-y-1">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-white/80 hover:text-white hover:bg-white/15 transition-all @if(request()->routeIs('dashboard')) bg-white/25 text-white font-medium backdrop-blur-sm @endif">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    <span>Inicio</span>
                </a>
<a href="{{ route('archivero.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-white/80 hover:text-white hover:bg-white/15 transition-all @if(request()->is('archivero*')) bg-white/25 text-white font-medium backdrop-blur-sm @endif">
                ...
                <a href="{{ route('gastos.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-white/80 hover:text-white hover:bg-white/15 transition-all @if(request()->is('gastos*')) bg-white/25 text-white font-medium backdrop-blur-sm @endif">
                ...
                <a href="{{ route('imagenes.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-white/80 hover:text-white hover:bg-white/15 transition-all @if(request()->is('formato-imagen*')) bg-white/25 text-white font-medium backdrop-blur-sm @endif">
