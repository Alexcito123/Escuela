        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
            <div class="max-w-3xl">
                ...
                <p class="text-lg sm:text-xl text-gray-500 mt-6 leading-relaxed max-w-2xl">
                    La plataforma educativa que conecta a padres y administradores en un solo lugar. Comparte materiales y organiza tu comunidad educativa.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all">
                    ...
                    <p class="text-sm text-gray-500">Conecta con padres y administradores fácilmente.</p>
                </div>
            </div>
        </div>
    </section>
