...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Nuevo Alumno</h1>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <form method="POST" action="{{ route('students.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                    ...
                    <button type="submit" class="bg-educlub hover:bg-educlub text-white px-6 py-2 rounded-xl font-medium transition">Guardar Alumno</button>
                </div>
            </form>
        </div>
    </div>
